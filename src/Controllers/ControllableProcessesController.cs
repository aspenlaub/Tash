...
public class ControllableProcessesController : ODataController {
    ...
    public IActionResult Get() {
        using (_SimpleLogger.BeginScope(SimpleLoggingScopeId.CreateWithRandomId(nameof(ControllableProcessesController) + nameof(Get)))) {
    ...
    public IActionResult Put(int key, [FromBody] ControllableProcess process) {
        using (_SimpleLogger.BeginScope(SimpleLoggingScopeId.CreateWithRandomId(nameof(ControllableProcessesController) + nameof(Put)))) {
            var methodNamesFromStack = _MethodNamesFromStackFramesExtractor.ExtractMethodNamesFromStackFrames();
    ...
    public IActionResult Patch(int key, Delta<ControllableProcess> patch) {
        using (_SimpleLogger.BeginScope(SimpleLoggingScopeId.CreateWithRandomId(nameof(ControllableProcessesController) + nameof(Patch)))) {
            var methodNamesFromStack = _MethodNamesFromStackFramesExtractor.ExtractMethodNamesFromStackFrames();
    ...
    public IActionResult Post([FromBody] ControllableProcess process) {
        using (_SimpleLogger.BeginScope(SimpleLoggingScopeId.CreateWithRandomId(nameof(ControllableProcessesController) + nameof(Post)))) {
            var methodNamesFromStack = _MethodNamesFromStackFramesExtractor.ExtractMethodNamesFromStackFrames();
    ...
    public IActionResult DeleteControllableProcess(int key) {
        using (_SimpleLogger.BeginScope(SimpleLoggingScopeId.CreateWithRandomId(nameof(DeleteControllableProcess)))) {
            var methodNamesFromStack = _MethodNamesFromStackFramesExtractor.ExtractMethodNamesFromStackFrames();
